...
$(document).ready(function(){
	...
	$(".main_menu ul li a, .goto_page_btn").click(function(){
		...
		$(".content > div#"+curr_page).removeClass(anim_in_f).addClass(anim_out_f).on(animEndEventName, function(){
			...
			$(".content > div#"+next_page).find(".jspContainer").css("width", $(".main_content").width());
			$(".content > div#"+next_page).find(".jspContainer .jspPane").css("width", $(".main_content").width());

			setTimeout(function(){
				if ($(".content > div#"+next_page).find(".jspContainer .jspVerticalBar").length == 0){
					$(".content > div#"+next_page).find(".jspPane").addClass("fullwidth");
				}else{
					$(".content > div#"+next_page).find(".jspPane").removeClass("fullwidth");
				}
			}, 1500);
	...
	jQuery(window).hashchange( function(e) {
		...
		$(".content > div#"+curr_page).removeClass(anim_in_f).addClass(anim_out_f).on(animEndEventName, function(){
			...
			if ($(window).width() <= 991){
				$(".content > div#"+next_page).addClass("fullwidth");
			}
	...
	$(window).resize(function(){
		...
		if (win_width <= 991){
			var p_width = $(".main_content").width();
			$(".jspContainer").width(p_width);
			$(".jspContainer .jspPane").width(p_width);
		}
	});
